...
export default function Login() {
  ...
  return (
    <div className="container min-h-screen flex items-center justify-center bg-gray-50 pt-15">
      <div className="bg-white rounded-3xl shadow-lg w-full max-w-sm p-10">
        <p className="text-sm font-bold text-gray-700 mb-1">Selamat datang!</p>
        <h1 className="text-5xl font-extrabold mb-8">Sign in</h1>
        {error && <p className="text-red-500 text-sm mb-4 text-center">{error}</p>}
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Enter your username or email address</label>
            <input
              type="text"
          ...
          <div className="relative">
            ...
            {/* <a href="#" className="text-xs text-red-500 float-right mt-1 hover:underline">Lupa kata sandi</a> */}
          </div>
          <button
            type="submit"
            className="w-full bg-blue-400 hover:bg-indigo-500 text-white font-semibold py-3 rounded-lg shadow-md transition duration-200"
          >
            Sign in
          </button>
        </form>
